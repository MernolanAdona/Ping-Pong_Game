...
starting_text = font_1.render("Choose set points", 1, (200, 255, 100))
...
while not game_over:
    ...
    if not finish:
        if chosen_point == 0:
            text_y = 250
            window.blit(starting_text, (50, 200))
        ...
        if game_status == None and chosen_point != 0:
            ...
            window.fill(background_color)
            window.blit(ending_text, (150, 200))    
            if point_r > point_l:
                winner = font_2.render("Player 2 wins the game", 1, (0, 255, 0))
            else:
                winner = font_2.render("Player 1 wins the game", 1, (0, 255, 0))
